...
    { name: 'Premium', price: '300', type: 'session', description: 'Enhanced experience with full benefits', 
    features: [
        'Access to All Sessions',
        'Badge & Note',
        'Certification of Participation',
        'Two Day Food & Accommodation',
        'Free Entry for Expo', 
...
    { name: 'Workshop Premium', price: '250', type: 'workshop', description: 'Complete workshop package with extras', features: ['Two Day Food & Accommodation', 'Badge & Note', 'Access to All Sessions', '25% Discount on All Books', 'Certificate of Participation', 'Special Swag Bag'], buttonText: 'Join Premium Workshop', recommended: true },
];
